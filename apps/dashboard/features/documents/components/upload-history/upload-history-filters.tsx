        ...
        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="terverifikasi" className="text-xs">
                Terverifikasi
              </SelectItem>
              <SelectItem value="menunggu_verifikasi" className="text-xs">
                Menunggu Verifikasi
              </SelectItem>
              <SelectItem value="tidak_terverifikasi" className="text-xs">
                Ditolak
              </SelectItem>
            </SelectContent>
          </Select>
