...
import { FileText, FileCheck, Clock, AlertTriangle, ArrowUpRight } from "lucide-react";
      ...
      <Card className="border border-border/60 bg-card shadow-sm hover:shadow-md transition-shadow">
        <CardContent className="p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="p-3 rounded-xl bg-amber-500/10 text-amber-600 dark:bg-amber-950 dark:text-amber-400 shrink-0">
