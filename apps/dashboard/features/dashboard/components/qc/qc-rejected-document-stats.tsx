    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      ...
      <Card className="border border-border/60 bg-card shadow-xs p-5">
        <div className="space-y-1">
          <span className="text-xs font-medium text-muted-foreground">Total Ditolak</span>
      ...
      <Card className="border border-border/60 bg-card shadow-xs p-5">
        <div className="space-y-1">
          <span className="text-xs font-medium text-muted-foreground">Perlu Revisi Uploader</span>
          <div className="text-3xl font-extrabold text-[#D08700]">
            {isLoading ? <Skeleton className="h-9 w-12" /> : stats.revisionNeededCount}
          </div>
        </div>
      </Card>
      ...
      <Card className="border border-border/60 bg-card shadow-xs p-5">
        <div className="space-y-1">
          <span className="text-xs font-medium text-muted-foreground">Ditolak Permanen</span>
          <div className="text-3xl font-extrabold text-foreground">
            {isLoading ? <Skeleton className="h-9 w-12" /> : stats.permanentRejectedCount}
          </div>
        </div>
      </Card>
    </div>
