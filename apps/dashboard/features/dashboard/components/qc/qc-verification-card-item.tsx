...
interface QCVerificationCardItemProps {
  doc: DocumentItem;
  idx?: number;
  isUrgent: boolean;
...
export function QCVerificationCardItem({
  doc,
  isUrgent,
  onOpenVerify,
  onOpenReject,
      ...
      <div className="p-5 sm:p-6 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div className="flex items-start gap-3.5 min-w-0">
            {/* Yellow Icon Circle Container */}
            <div className="w-12 h-12 rounded-xl bg-[#FEF9C2] text-amber-700 dark:bg-amber-950 dark:text-amber-300 flex items-center justify-center shrink-0 shadow-2xs mt-0.5">
              <FileText className="w-6 h-6" />
            </div>

            <div className="min-w-0 space-y-1">
              <div className="flex flex-wrap items-center gap-2">
                <h3 className="text-base font-bold text-foreground truncate hover:text-amber-600 transition-colors">
                  {docTitle}
                </h3>
              </div>

              {/* Uploader & Date Sub-info */}
          ...
          <div className="flex items-center gap-2 shrink-0">
            {isUrgent && (
              <Badge
                variant="destructive"
                className="bg-[#FFE2E2] text-[#C10007] border-0 font-semibold text-xs py-0.5 px-3 rounded-full shadow-2xs"
              >
                Urgent
              </Badge>
            )}
        ...
        <div className="flex items-center justify-end gap-3 pt-2 border-t border-border/40">
          ...
          <Button
            ...
            className="h-9 bg-[#E7000B] hover:bg-[#c10007] text-white font-medium text-xs gap-1.5 px-4 shadow-xs"
          >
          ...
          <Button
            ...
            disabled={isVerifying}
            className="h-9 bg-[#00C951] hover:bg-[#00a642] text-white font-medium text-xs gap-1.5 px-4 shadow-xs"
          >
