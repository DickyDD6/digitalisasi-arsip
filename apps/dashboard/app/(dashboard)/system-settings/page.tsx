...
import { Settings, Bell, HardDrive, Save, CheckCircle2 } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription className="text-sm text-muted-foreground mt-1">
                Konfigurasi preferensi sistem, notifikasi, dan parameter peran
                pengguna
              </CardDescription>
            </div>
            <Button
        ...
        <TabsContent value="role-settings" className="mt-4 space-y-4">
            ...
            <Card className="border border-border/60 shadow-sm">
              <CardHeader className="p-5">
                <CardTitle className="text-base font-semibold">
                  Pengaturan Manajer Arsip
                </CardTitle>
                <CardDescription className="text-xs">
                  Kebijakan retensi dokumen, batas verifikasi, dan kontrol hak
                  akses
                </CardDescription>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-4 text-xs">
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    <p className="font-semibold text-foreground">
                      Batas Waktu Peringatan Verifikasi QC
                    </p>
                    <p className="text-muted-foreground">
                      Beri peringatan jika dokumen pending &gt; 3 hari
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
                ...
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Simpan arsip aktif periode 2000-2010 secara permanen
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
                    className="bg-[#F54A00]/10 text-[#F54A00]"
                  >
                    PERMANEN
                  </Badge>
                </div>
            ...
            <Card className="border border-border/60 shadow-sm">
              ...
              <CardContent className="p-5 pt-0 space-y-4 text-xs">
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    <p className="font-semibold text-foreground">
                      Pemeriksaan OCR Otomatis
                    </p>
                    <p className="text-muted-foreground">
                      Deteksi teks nama &amp; NPM otomatis saat verifikasi
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
                ...
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Wajib mengisi alasan saat menolak dokumen uploader
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
            ...
            <Card className="border border-border/60 shadow-sm">
              ...
              <CardContent className="p-5 pt-0 space-y-4 text-xs">
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    <p className="font-semibold text-foreground">
                      Kompresi PDF Otomatis
                    </p>
                    <p className="text-muted-foreground">
                      Optimalkan ukuran file PDF yang diunggah
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
                ...
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    <p className="font-semibold text-foreground">
                      Validasi Ekstensi File (PDF/PNG)
                    </p>
                    <p className="text-muted-foreground">
                      Batasi jenis file hanya PDF dan PNG
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
          ...
          {role === "sbap" && (
            <Card className="border border-border/60 shadow-sm">
              <CardHeader className="p-5">
                <CardTitle className="text-base font-semibold">
                  Pengaturan Staff Biro Akademik (SBAP)
                </CardTitle>
                <CardDescription className="text-xs">
              ...
              <CardContent className="p-5 pt-0 space-y-4 text-xs">
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    <p className="font-semibold text-foreground">
                      Watermark Resmi FT Unpas
                    </p>
                    <p className="text-muted-foreground">
                      Cetak stempel watermark resmi pada unduhan dokumen
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
                ...
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    <p className="font-semibold text-foreground">
                      Format Default Unduhan Bulk
                    </p>
                    <p className="text-muted-foreground">
                      Kemasi multiple dokumen dalam format ZIP
                    </p>
                  </div>
                  <Badge
                    variant="secondary"
            ...
            <CardContent className="p-5 pt-0 space-y-4 text-xs">
              <div className="flex items-center justify-between p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Tampilkan indikator angka notifikasi belum dibaca
                  </p>
                </div>
                <Badge
                  variant="secondary"
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Terima info saat dokumen diverifikasi / ditolak
                  </p>
                </div>
                <Badge
                  variant="secondary"
            ...
            <Card className="border border-border/60 shadow-sm">
              ...
              <CardContent className="p-5 pt-0 space-y-4 text-xs">
                <div className="flex items-center justify-between p-3 rounded-lg border">
                  <div>
                    <p className="font-semibold text-foreground">
                      Export Log Audit CSV
                    </p>
                    <p className="text-muted-foreground">
                      Unduh log aktivitas sistem terbaru
                    </p>
                  </div>
