...
## Autentikasi
API ini menggunakan Laravel Sanctum dengan session-based authentication.
...
#[OA\Tag(name: 'Reports', description: 'Report Generation & Dashboard Statistics (UC-09) - Manager only')]
